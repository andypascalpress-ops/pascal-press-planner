...
export interface GA4ChannelRevenue {
  /** Revenue attributed to CPC (Google Ads) sessions */
...
/**
 * Fetch PP revenue by medium (cpc vs organic) for a single month.
 */
...
/**
 * Fetch PP revenue by medium for a date range, aggregated by calendar month.
 */
